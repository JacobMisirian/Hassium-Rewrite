...
namespace Hassium.Runtime.StandardLibrary.Types
{
    public class HassiumDouble: HassiumObject
    {
        ...
        public HassiumDouble(double value)
        {
            ...
            Attributes.Add(HassiumObject.PRE_INCREMENT, new HassiumFunction(__preincrement__, 0));
            Attributes.Add(HassiumObject.PRE_DECREMENT, new HassiumFunction(__predecrement__, 0));
            Attributes.Add(HassiumObject.POST_INCREMENT, new HassiumFunction(__postincrement__, 0));
            Attributes.Add(HassiumObject.POST_DECREMENT, new HassiumFunction(__postdecrement__, 0));
        ...
        private HassiumDouble __postincrement__ (VirtualMachine vm, HassiumObject[] args)
        {
            return new HassiumDouble(Value++);
        }
        private HassiumDouble __postdecrement__ (VirtualMachine vm, HassiumObject[] args)
        {
            return new HassiumDouble(Value--);
        }
        private HassiumDouble __preincrement__ (VirtualMachine vm, HassiumObject[] args)
        {
            return new HassiumDouble(++Value);
        }
        private HassiumDouble __predecrement__ (VirtualMachine vm, HassiumObject[] args)
        {
            return new HassiumDouble(--Value);
        }
